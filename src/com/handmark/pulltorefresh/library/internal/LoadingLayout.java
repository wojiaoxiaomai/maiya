...
public abstract class LoadingLayout extends FrameLayout implements
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		case PULL_FROM_END:
			...
			// Load in labels
			mPullLabel = context
					.getString(R.string.pull_to_refresh_pull_label_from_end);
			mRefreshingLabel = context
					.getString(R.string.pull_to_refresh_refreshing_label_from_end);
			mReleaseLabel = context
					.getString(R.string.pull_to_refresh_release_label_from_end);
			break;
